...
#load in imagepaths and shuffle them
...
#Fit_generator is deprecated but plaidml doesn't support the normal .fit and aug.flow
#for some reason it keeps returning a error due to it not being a numpy array in the plaidml code 
#using fit_generator avoids that error
